    ...
    <div class="card-body">
        <table id="dataTableEl" class="table table-bordered table-striped">
            ...
            <div class="row mb-4 mt-3">
                ...
                <div class="col-md-4"><label> Txn Id</label>
                    <input class='form-control trackingId ' id='trackingId' type='text' value='' />
                </div>
...
<script>
    ...
    function makeDt(res) {
        ...
        $("#orderStatus").val(tableData[0].orderStatus);
        $("#trackingId").val(tableData[0].order.trackingId);
        setTimeout(() => {
            loadDt();
        }, 0)
