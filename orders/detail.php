    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          $columns = ["orderId","url","arts.productImage","arts.productName","price","qty","user.name",
          ...
          "createdAt"];
          $columnsFace = ["Order Id","Download Invoice","ProductImage","Product Name","Price","Product Qty","Purchased By",
